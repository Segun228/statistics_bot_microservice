...
urlpatterns = [
    ...
    path("chi-square/<int:dataset_id>/", views.Chi_TestView.as_view(), name="chi_square_test"),
    path("chi-square-2sample/<int:dataset_id>/", views.Chi_2Sample_TestView.as_view(), name="chi_square_2sample_test"),

    # Непараметрические тесты
    path("ks-test/<int:dataset_id>/", views.KS_test_View.as_view(), name="ks_test"),
    ...
    path("regression-test/<int:dataset_id>/", views.Regression_test_View.as_view(), name="regression_test"),
