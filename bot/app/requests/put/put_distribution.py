...
async def put_distribution(telegram_id, distribution_id, name, distribution_type, distribution_parameters):
    load_dotenv()
...
async def main():
    try:
        response_data = await put_distribution(telegram_id=6911237041,distribution_id=2, name="Тест через прогу", distribution_type="normal", distribution_parameters={"mu":0, "sigma":1})
