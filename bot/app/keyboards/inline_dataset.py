...
async def get_dataset_criteria_menu(dataset_id):
    keyboard = InlineKeyboardBuilder()
    keyboard.add(InlineKeyboardButton(text="Z-test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Student t-test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="χ² Pearson test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="χ² 2 sample Pearson test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="U - test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Welch’s t-test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Anderson-Darling test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="KS test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="KS two-sample test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Shapiro-Wilke test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Lilleforce test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Bootstrap", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="ANOVA", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="Regression test", callback_data=f"_{dataset_id}"))
    keyboard.add(InlineKeyboardButton(text="CUPED", callback_data=f"_{dataset_id}"))
